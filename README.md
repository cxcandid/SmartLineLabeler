...
![SmartLineLabeler Example](../images/image1.png)
...
After activating the SmartLineLabeler plugin (![SmartLineLabeler Icon](../images/image2.png)) a toolbar will appear on top of map canvas.

![SmartLineLabeler Toolbar](../images/image3.png)
...
![SmartLineLabeler first label stack](../images/basic1.gif)
...
![Layer Labeling Options](../images/image5.png)

Here we can replace the feature ID with a different attribute using the 
Expression Builder (![Expression Builder Icon](../images/image6.png)).

![Expression Builder](../images/image7.png)

![Expression Builder Detail](../images/image8.png)
...
![SmartLineLabeler Basic Labeling](../images/image9.png)
...
![SmartLineLabeler adjust Label Direction](../images/basic2.gif)

While dragging the rubber band line, we can press the <F5> key to toggle the text alignment.

![SmartLineLabeler toggle Text Alignment](../images/basic3.gif)
...
![SmartLineLabeler use Reference Point](../images/basic4.gif)

Now that we have created several stacks of labels, we can observe their behavior during a zoom.

![SmartLineLabeler Zoom Behavior with MM Units](../images/basic5.gif)
...
![SmartLineLabeler change Label Units](../images/image14.png)

Then, we press the “Label Settings” tool button to adapt the plugin settings:

![SmartLineLabeler Label Settings Icon](../images/image15.png)

![SmartLineLabeler Label Settings](../images/image16.png)

As a final step, we need to update the existing labels by pressing the “Update Labels” button in the plugin toolbar.
![SmartLineLabeler Update Labels Button](../images/image17.png)

When we zoom in now, the size of the label texts changes.

![SmartLineLabeler Zoom Behavior with Map Units](../images/basic6.gif)
...
![SmartLineLabeler Advanced Labeling](../images/image19.png)
...
![Field Calculator - field "txt"](../images/image20.png)
...
![Field Calculator - field "label_offset"](../images/image21.png)
...
![Expression Builder](../images/image22.png)

…and configure the characters for the line wrap (“||”).

![Configure Characters for Line Wrap](../images/image23.png)

If we like, we can configure a background to our labels.

![Configure Label Background](../images/image24.png)
...
![Scale Dependent Visibility for the Label Layer](../images/image25.png)
...
![SmartLineLabeler Advanced Usage](../images/advanced1.gif)
...
![SmartLineLabeler Change Distance and Tick Length](../images/advanced2.gif)

And we can automatically remove labels, if we filter the cable layer.

![SmartLineLabeler filter Source Layer](../images/advanced3.gif)
...
![SmartLineLabeler Layer Join](../images/image29.png)
...
![Export Label Layer](../images/image30.png)
...
![SmartLineLabeler make Label Layer permanent](../images/advanced4.gif)
...
![SmartLineLabeler Problems](../images/image32.png)
